...
public class StudentBuilderTest {
	...
	public void buildTest() throws InvalidInputException {
		Student sbuilt = StudentBuilder.newBuilder("111").fullname("Mario", "Rossi").password("aaaaa1@").email("mariorossi@blabla.com").phone("3336669990").build();
		Student scostructor = new Student("111", "aaaaa1@", "mariorossi@blabla.com", "Mario", "Rossi", "3336669990");
		//TODO: Test, Change to sbuilt.equals()
